...
public class WikitudeLocationProvider implements ILocationProvider {
    ...
    public WikitudeLocationProvider(final Context context, LocationListener locationListener) {
        super();
    ...
    public void onResume() {
        if (this.locationManager != null && this.locationListener != null) {
            ...
            try {
                ...
                Log.i("LocationProvider", e.getMessage());
            }
